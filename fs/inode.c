 ...
 *
 * Note both @test and @set are called with the hlist_bl_lock() held, so can't
 * sleep.
 */
 ...
 *
 * Note2: @test is called with the hlist_bl_lock() held, so can't sleep.
 */
 ...
 *
 * Note: @test is called with the hlist_bl_lock() held, so can't sleep.
 */
